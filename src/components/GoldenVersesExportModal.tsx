          ...
          <div className="lg:col-span-8 p-3 sm:p-5 md:p-6 bg-[#0c0a08] overflow-y-auto max-h-[82vh] flex flex-col items-center">
            ...
            >
              ...
              <div className={`p-6 rounded-xl border text-center space-y-2.5 ${themeClasses.headerBg}`}>
                ...
                <div className="flex items-center justify-center gap-3 pb-3 mb-2 border-b border-amber-900/20">
                  <div className="w-12 h-12 rounded-full p-0.5 shrink-0 bg-gradient-to-tr from-amber-700 via-amber-400 to-amber-600 shadow-md">
                    <img
                      src={appLogoImg}
                  ...
                  <div className="flex flex-col text-left">
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      <span className="text-[10px] px-1.5 py-0.5 rounded font-mono font-bold tracking-widest border border-amber-500/40 bg-amber-500/10 text-amber-500">
                        ΕΓΩ ΕΙΜΙ
                      </span>
                    </div>
