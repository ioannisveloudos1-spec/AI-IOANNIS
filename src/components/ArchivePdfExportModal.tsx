                ...
                return (
                  ...
                  >
                    ...
                    {isFirstPage ? (
                      ...
                      >
                        {/* Application Brand Logo & Name: ΙΩΑΝΝΗΣ ΒΕΛΟΥΔΟΣ ΕΓΩ ΕΙΜΙ */}
                        <div
                          className="flex items-center justify-center gap-3 pb-3 mb-3 border-b"
                          style={{ borderColor: palette.borderSubtle }}
                        >
                          <div
                            className="w-12 h-12 rounded-full p-0.5 shrink-0 shadow-sm"
                            style={{
                              background: `linear-gradient(135deg, ${palette.accent}, ${palette.textPrimary})`,
                            }}
                          >
                            <img
                              src={appLogoImg}
