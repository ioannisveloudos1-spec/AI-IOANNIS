...
export const GreekFontSelectorModal: React.FC<GreekFontSelectorModalProps> = ({
  ...
  return (
    <div
      id="greek-font-selector-modal"
      className="export-report-modal fixed inset-0 z-[100] flex items-center justify-center p-3 sm:p-5 bg-black/85 backdrop-blur-md animate-in fade-in duration-200"
      style={{ zIndex: 100 }}
    >
      <div
        className="relative w-full max-w-4xl bg-[#16130f] border border-[#3e3020] rounded-2xl shadow-[0_25px_60px_rgba(0,0,0,0.95)] overflow-hidden flex flex-col max-h-[90vh]"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Modal Header */}
        <div className="flex items-center justify-between px-4 sm:px-6 py-4 border-b border-[#2d2419] bg-gradient-to-r from-[#1c1712] via-[#241c14] to-[#1c1712] shrink-0">
        ...
        <div className="px-4 sm:px-6 py-2.5 bg-[#1a140e] border-b border-[#2d2419] flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 shrink-0">
        ...
        <div className="px-4 sm:px-6 py-2 bg-[#120f0c] border-b border-[#2d2419] flex items-center gap-1.5 overflow-x-auto gold-scrollbar shrink-0">
        ...
        <div className="px-4 sm:px-6 py-3 bg-[#14100c] border-b border-[#2d2419] shrink-0">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 p-3 rounded-xl bg-[#1b1611] border border-[#3a2d1d]">
            ...
            <div
              className="text-base sm:text-xl font-bold tracking-wider text-[#ffd700] px-3 py-1.5 rounded-lg bg-[#14100c] border border-[#2d2216] break-words"
        ...
        {/* Scrollable Font Cards List — 2-Column Grid with No Overlap */}
        <div className="p-3 sm:p-5 overflow-y-auto space-y-3 gold-scrollbar flex-1">
            ...
            {filteredFonts.map((font) => {
              ...
              return (
                <button
                  ...
                  className={`group relative text-left p-4 rounded-xl border transition-all cursor-pointer flex flex-col justify-between gap-3 min-h-[140px] ${
                    isSelected
                      ? "bg-gradient-to-br from-[#241c13] via-[#2d2215] to-[#1f1710] border-[#ffd700] shadow-lg shadow-[#c89b3c]/20 ring-1 ring-[#ffd700]"
                ...
                >
                  ...
                  <div className="flex items-start justify-between w-full gap-2">
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center gap-1.5 flex-wrap">
                        <span className="font-sans font-bold text-sm text-[#f5ecd8] group-hover:text-[#fff] truncate">
                          {font.name}
                        </span>
                        <span className="text-[9px] px-1.5 py-0.5 rounded bg-[#2a2016] text-[#c89b3c] border border-[#443321] whitespace-nowrap shrink-0">
                          {font.era}
                        </span>
                      </div>
                      <span className="text-[11px] text-[#91816d] font-sans block mt-0.5">
                        {font.category}
                      </span>
                    </div>

                    <div
                      className={`w-6 h-6 rounded-full flex items-center justify-center shrink-0 border transition-all ml-1 ${
                        isSelected
                          ? "bg-[#c89b3c] border-[#ffd700] text-[#14100c]"
                  ...
                  <div className="w-full py-2.5 px-3 rounded-lg bg-[#120e0a] border border-[#261d13] overflow-hidden">
                    <div
                      className="text-base sm:text-lg font-bold text-[#e6c670] tracking-wide break-words leading-tight"
                      style={{ fontFamily: font.fontFamily }}
                    >
                      {font.sampleText}
                    </div>
                    <div
                      className="text-xs text-[#a69680] tracking-wider mt-1 break-words leading-tight"
                      style={{ fontFamily: font.fontFamily }}
                    >
                  ...
                  {/* Font Description */}
                  <p className="text-[11px] text-[#8a7b69] font-sans leading-relaxed">
                    {font.description}
                  </p>
                </button>
              );
        ...
        {/* Modal Footer */}
        <div className="px-4 sm:px-6 py-3.5 border-t border-[#2d2419] bg-[#14100c] flex items-center justify-between gap-3 shrink-0">
          ...
          <button
            type="button"
            onClick={onClose}
            className="w-full sm:w-auto px-6 py-2.5 rounded-xl bg-gradient-to-r from-[#8a6825] via-[#c89b3c] to-[#e6c670] text-[#14100c] font-sans font-bold text-xs sm:text-sm hover:brightness-110 active:scale-95 transition-all shadow-md shadow-[#c89b3c]/20 cursor-pointer"
          >
            Εφαρμογή &amp; Κλείσιμο
          </button>
        </div>
