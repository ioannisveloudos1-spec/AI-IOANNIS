...
import { X, Search, BookOpen, Sparkles, BookMarked, Tag, Scroll } from "lucide-react";
...
export const CodexPanel: React.FC<CodexPanelProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 bg-black/85 backdrop-blur-md animate-fade-in">
      <div className="relative w-full max-w-5xl max-h-[92vh] bg-[#0a0a14] border border-amber-500/30 rounded-2xl shadow-2xl flex flex-col overflow-hidden text-zinc-100">
        {/* Header */}
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold text-zinc-100 flex items-center gap-2">
                Μεταφυσικός & Ετυμολογικός Κώδικας
              </h2>
              <p className="text-xs text-zinc-400">
                Λήμματα αρχαίας σοφίας, ισοψηφίας, ετυμολογικών αποκαλύψεων και μυστηρίων
              </p>
            </div>
          </div>
          <button
        ...
        {/* Entries List */}
        <div className="p-4 sm:p-6 overflow-y-auto flex-1 custom-scrollbar grid grid-cols-1 md:grid-cols-2 gap-4">
