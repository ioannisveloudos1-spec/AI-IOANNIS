...
// Built-in English Isopsephy Corpus (Base 6: A=6, B=12... Z=156)
export const ENGLISH_BASE6_CORPUS: Record<number, Array<{ text: string; meaning: string; source: string }>> = {
  666: [
    { text: "MARK OF BEAST", meaning: "Το Χάραγμα του Θηρίου (Αποκάλυψη)", source: "Αγγλική Ισοψηφία" },
    { text: "COMPUTER", meaning: "Υπολογιστής (C=18, O=90, M=78, P=96, U=126, T=120, E=30, R=108 = 666)", source: "Βάση Ισοψηφιών" },
    { text: "CORONA VIRUS", meaning: "Κορωνοϊός (C=18, O=90, R=108, O=90, N=84, A=6 + V=132, I=54, R=108, U=126, S=114 = 666)", source: "Βάση Ισοψηφιών" },
    { text: "DIGITAL CURRENCY", meaning: "Ψηφιακό Νόμισμα / CBDC", source: "Αγγλική Ισοψηφία" },
    { text: "NEW YORK", meaning: "Νέα Υόρκη (N=84, E=30, W=138, Y=150, O=90, R=108, K=66 = 666)", source: "Αγγλική Ισοψηφία" },
    { text: "ILLUMINATI", meaning: "Οι Πεφωτισμένοι", source: "Βάση Ισοψηφιών" },
    { text: "VACCINATION", meaning: "Εμβολιασμός", source: "Βάση Ισοψηφιών" },
    { text: "LUCIFER FALL", meaning: "Η πτώση του Εωσφόρου", source: "Αγγλική Ισοψηφία" },
    { text: "THE DRAGON", meaning: "Ο Δράκων της Αποκαλύψεως", source: "Αγγλική Ισοψηφία" },
    { text: "GENETIC CODE", meaning: "Γενετικός Κώδικας", source: "Βάση Ισοψηφιών" },
    { text: "SMART CARD", meaning: "Έξυπνη Κάρτα / Chip", source: "Βάση Ισοψηφιών" },
    { text: "MONETARY SYSTEM", meaning: "Νομισματικό Σύστημα", source: "Αγγλική Ισοψηφία" },
    { text: "BIO WEAPON", meaning: "Βιολογικό Όπλο", source: "Βάση Ισοψηφιών" },
    { text: "A WORLD LEADER", meaning: "Παγκόσμιος Ηγέτης", source: "Αγγλική Ισοψηφία" },
    { text: "GLOBAL ORDER", meaning: "Παγκόσμια Τάξη", source: "Αγγλική Ισοψηφία" },
    { text: "FALSE PROPHET", meaning: "Ψευδοπροφήτης (Αποκάλυψη)", source: "Αγγλική Ισοψηφία" },
    { text: "SATANIC RITUAL", meaning: "Σατανική Τελετουργία", source: "Βάση Ισοψηφιών" },
    { text: "THE SYNAGOGUE", meaning: "Η Συναγωγή", source: "Αγγλική Ισοψηφία" },
    { text: "SON OF PERDITION", meaning: "Ο Υιός της Απωλείας", source: "Αγγλική Ισοψηφία" },
  ],
  888: [
    { text: "SAVED IN JESUS", meaning: "Σωσμένος στον Ιησού", source: "Αγγλική Ισοψηφία (888)" },
    { text: "RIGHTEOUS GOD", meaning: "Δίκαιος Θεός", source: "Αγγλική Ισοψηφία (888)" },
    { text: "MORNING STAR", meaning: "Πρωινό Άστρο / Ο Αστήρ ο Πρωινός", source: "Αγγλική Ισοψηφία (888)" },
    { text: "ONE TWO THREE", meaning: "Ένα, δύο, τρία", source: "Αγγλική Ισοψηφία (888)" },
    { text: "A MESSAGE FROM GOD", meaning: "Ένα μήνυμα από τον Θεό", source: "Αγγλική Ισοψηφία (888)" },
    { text: "YOUR REAL NAME", meaning: "Το πραγματικό σου όνομα", source: "Αγγλική Ισοψηφία (888)" },
    { text: "NUCLEAR WEAPON", meaning: "Πυρηνικό όπλο", source: "Αγγλική Ισοψηφία (888)" },
    { text: "WE ARE NOT ALONE", meaning: "Δεν είμαστε μόνοι", source: "Αγγλική Ισοψηφία (888)" },
    { text: "ESSENTIAL INFO", meaning: "Βασικές πληροφορίες", source: "Αγγλική Ισοψηφία (888)" },
    { text: "NORTH CAROLINA", meaning: "Βόρεια Καρολίνα", source: "Αγγλική Ισοψηφία (888)" },
    { text: "KING OF KINGS", meaning: "Βασιλεύς Βασιλέων", source: "Αγγλική Ισοψηφία (888)" },
    { text: "THE MESSIAH", meaning: "Ο Μεσσίας", source: "Αγγλική Ισοψηφία (888)" },
  ],
  777: [
    { text: "DIVINE PERFECTION", meaning: "Θεία Τελειότητα", source: "Αγγλική Ισοψηφία" },
    { text: "GOD OF HEAVEN", meaning: "Ο Θεός των Ουρανών", source: "Αγγλική Ισοψηφία" },
  ],
};
