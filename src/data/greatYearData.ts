  ...
  etymologyZoDia: {
    ...
    isopsephicCodes: [
      ...
      },
      {
        ...
        meaning: "Ο Ζωοδότης Πατήρ, η πηγή της ουράνιας διάταξης (ΔΙ' ΟΝ ΤΑ ΠΑΝΤΑ ΖΩΣΙΝ). Εκ της Διαιρέσεως του Ενός στα πολλά."
      },
      {
        term: "ΖΕΥΣ",
        value: 612,
        breakdown: "Ζ(7) + Ε(5) + Υ(400) + Σ(200) = 612",
        meaning: "Εκ της Ζεύξεως (ένωση του αοράτου βάθους με το φανερωμένο ον δια του Νου)."
      },
      {
        term: "ΤΡΙΑΔΙΚΟΣ ΘΕΟΣ",
        value: 999,
        breakdown: "ΤΡΙΑΔΙΚΟΣ(715) + ΘΕΟΣ(284) = 999 (Πυθμένας: 9)",
        meaning: "Ο Τριαδικός Πυράνιος Ζευς (Ζευς - Ποσειδών - Άδης/Πλούτων). Η υπέρτατη κλίμακα της θείας Εννεάδος."
      },
      {
        term: "ΙΧΘΥΣ = ΠΟΣΕΙΔΩΝ",
        value: 1219,
        breakdown: "ΙΧΘΥΣ(1219) = ΠΟΣΕΙΔΩΝ(1219) = ΣΩΘΙΣ(1219)",
        meaning: "Η μυστική ισοψηφική ταυτότητα του Χριστού (ΙΧΘΥΣ) με τον άρχοντα των υδάτων (ΠΟΣΕΙΔΩΝ = Πόσις Ειδών) και το ιερό άστρο Σώθις."
      },
      {
        term: "ΕΝΙΑΥΤΟΣ",
        value: 1036,
...
export const ZODIAC_SIGNS_DATA: ZodiacSignData[] = [
  ...
  },
  {
    ...
    greatAgeHistory: "Η ΤΡΕΧΟΥΣΑ ΝΕΑ ΕΠΟΧΗ του Μέγα Ενιαυτού, με εκκίνηση το Millennium (2000 μ.κ.χ. [μ.Χ.]). Μετά τη μακρά βύθιση στον συναισθηματικό και υδάτινο ωκεανό των Ιχθύων (Ποσειδών = 1219), η ανθρωπότητα αναδύεται στον ουράνιο αιθέρα του Υδροχόου. Χαρακτηρίζεται από την κατάργηση των τυφλών δογμάτων, την έκχυση του ουράνιου Ύδατος της Σοφίας σε όλη την ανθρωπότητα, την τεχνολογική και πνευματική ένωση, την κατανόηση των συμπαντικών κυμάτων και του Αιθέρος.",
    theologicalConnection: "Ο Υδροχόος είναι ο Γανυμήδης που προσφέρει το νέκταρ των Θεών στους ανθρώπους ή ο Προμηθέας που φέρνει το ουράνιο πυρ της νόησης. Συμβολίζει την αδελφοσύνη, την απελευθέρωση της ανθρωπότητας και την άνοδο από το συναίσθημα στη συμπαντική νόηση.",
  ...
  },
  {
    ...
    precessionOrder: 12,
    greatAgeArchetype: "Εποχή των Ιχθύων / Πίστις, Συναίσθημα, Ωκεάνιος Συγχώνευση & ΙΧΘΥΣ = 1219 = ΠΟΣΕΙΔΩΝ",
    greatAgeHistory: "Η ιστορική εποχή από το 160 π.κ.χ. (π.Χ.) έως το 2000 μ.κ.χ. (μ.Χ.). Ο Ιησούς Χριστός γεννήθηκε στο 1 μ.κ.χ. (μ.Χ.), δηλαδή στο 160ό έτος Μετά Ιχθύος (2° 13' 20'' των Ιχθύων). Κυριαρχία του ιερού συμβόλου και ακρωνυμίου του Ιχθύος: ΙΧΘΥΣ (Ἰησοῦς Χριστὸς Θεοῦ Υἱὸς Σωτήρ = 1219). Ισοψηφεί απόλυτα με τον κυβερνήτη των υδάτων ΠΟΣΕΙΔΩΝΑ = 1219 («Πόσις Εἰδῶν», ο σύζυγος και τροφός των ειδών δια του Ύδατος ως «Υψίστου Δώρου») και με το ιερό άστρο ΣΩΘΙΣ = 1219. Υπήρξε η κατεξοχήν εποχή του στοιχείου του Ύδατος και του συναισθήματος, της βαθιάς πίστεως, των ωκεάνιων εξερευνήσεων και του μυστικισμού.",
    theologicalConnection: "Ο Ποσειδών (1219), ο Άδης-Πλούτων (το αόρατο Πολυούσιον Ον) και ο Ζευς (η Ζεύξις του Νου) είναι οι τρεις εκφάνσεις του Ενός Παμμέγιστου Διός (ΤΡΙΑΔΙΚΟΣ ΘΕΟΣ = 999). Στους Ιχθύες, η ανθρώπινη ψυχή βυθίζεται στα ποσειδώνια ύδατα του συναισθήματος και της δοκιμασίας για να λυτρωθεί δια του Σωτήρος Ιχθύος. Οι δύο Ιχθύες, δεμένοι με χρυσό δεσμό (ο ένας στραμμένος στον ουρανό και ο άλλος στην ύλη), συμβολίζουν την ολοκλήρωση της ενσάρκωσης και τη σωτηρία.",
    zoDiaEtymology: "ΖΩΗ ΔΙΑ ΤΟΥ ΥΔΑΤΟΣ (ΥΨΙΣΤΟΝ ΔΩΡΟΝ): Η διάχυση της θείας ζωής του Διός μέσω του Ποσειδώνος (1219) και του Ιχθύος (1219) σε όλα τα είδη της δημιουργίας.",
    isopsephyWord: "ΙΧΘΥΣ = ΠΟΣΕΙΔΩΝ",
    isopsephyValue: 1219,
    isopsephyBreakdown: "ΙΧΘΥΣ (1219) = ΠΟΣΕΙΔΩΝ (1219) = ΣΩΘΙΣ (1219) [ΙΧΘΥΕΣ = 1224]"
  }
];
