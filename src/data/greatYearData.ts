...
export const GREAT_YEAR_COSMOLOGY: GreatYearCosmology = {
  ...
  hipparchusDiscovery: "Ο μέγιστος αρχαίος Έλληνας αστρονόμος Ίππαρχος ο Ρόδιος (190–120 π.Χ.) ανακάλυψε και μέτρησε μαθηματικά τη Μετάπτωση των Ισημεριών (Προπόρευσιν), συγκρίνοντας τις δικές του αστρονομικές παρατηρήσεις με εκείνες του Τιμοχάριδος και του Αριστύλλου (300 π.Χ.), διαπιστώνοντας τη μετατόπιση του εαρινού ισημερινού σημείου κατά 1° κάθε ~72 έτη.",
  aquariusEpochInsight: {
    title: "Η Μετάβαση στον Υδροχόο (2000 μ.Χ.) & η Έλευση του Χριστού (160 Μετά Ιχθύος)",
    description: "Με δεδομένη τη μετάβαση στην Εποχή του Υδροχόου στο Millennium (2000 μ.Χ.), η Εποχή των Ιχθύων (διάρκειας 2.160 ετών) ξεκίνησε το 160 π.Χ. (160 π.Χ. + 2000 μ.Χ. = 2.160 έτη). Κατά συνέπεια, η γέννηση του Ιησού Χριστού (1 μ.Χ.) έλαβε χώρα ακριβώς στο 160ό έτος της Εποχής των Ιχθύων (160 Μετά Ιχθύος, δηλαδή στην 2° 13' 20'' των Ιχθύων). Σήμερα, εν έτει 2026 μ.Χ., διανύουμε το 26ο έτος της Εποχής του Υδροχόου (2026 - 2000 = 26 έτη), το οποίο αντιστοιχεί ακριβώς στην 0° 21' 40'' του Υδροχόου (26 ÷ 72 = 0,36111°).",
    scientificRelativity: {
      title: "Επιστημονική & Αστρονομική Σχετικότητα της Μετάβασης (Μαθηματικό Μοντέλο vs Πραγματικός Ουρανός)",
      summary: "Δεν υφίσταται μία ενιαία, αδιαμφισβήτητη ημερομηνία εισόδου της Γης στον Υδροχόο. Το έτος 2000 μ.Χ. αποτελεί ένα συμβατικό, αυστηρά ισομεγέθες μαθηματικό ορόσημο (12 × 30° = 360° / 12 × 2.160 = 25.920 έτη). Στην πραγματική αστρονομική παρατήρηση, η αλλαγή εποχής είναι μια μακρά μεταβατική ζώνη αιώνων.",
      reasons: [
        {
          title: "Απουσία Φυσικών Συνόρων & Τεχνητά Όρια (IAU)",
          desc: "Στον ουρανό δεν υπάρχουν χαραγμένες διαχωριστικές γραμμές. Τα επίσημα όρια της Διεθνούς Αστρονομικής Ένωσης (IAU, 1928) είναι συμβατικά. Επειδή ο αστερισμός των Ιχθύων είναι αστρονομικά τεράστιος (~37°), με βάση τα σύνορα της IAU η εαρινή ισημερία θα περάσει στον Υδροχόο περί το 2600 μ.Χ."
        },
        {
        ...
        },
        {
          ...
          desc: "Ο Τροπικός Ζωδιακός, ο Αστρικός (Sidereal / Lahiri, Fagan-Bradley) και οι διάφορες φιλοσοφικές παραδόσεις τοποθετούν την έναρξη μεταξύ 1950, 2000, 2060, 2150 ή και 2600 μ.Χ. Το παρόν ημερολόγιο υιοθετεί το κλασικό Πυθαγόρειο-Πλατωνικό αρμονικό μοντέλο των 2.160 ετών ανά εποχή με αφετηρία τη χιλιετία."
        }
      ],
      comparisons: [
        { model: "Πυθαγόρειο / Μαθηματικό Μοντέλο (Ισομεγέθης Ζωδιακός)", entryYear: "2000 μ.Χ.", notes: "12 εποχές × 2.160 έτη = 25.920 έτη (Αφετηρία 2000 μ.Χ.)" },
        { model: "Αστρικό Σύστημα (Lahiri Ayanamsha)", entryYear: "~2080 – 2150 μ.Χ.", notes: "Βασισμένο στην αστέρα Spica (Chitra) στις 0° Ζυγού" },
        { model: "Όρια Διεθνούς Αστρονομικής Ένωσης (IAU)", entryYear: "~2600 μ.Χ.", notes: "Ανισομεγέθη όρια αστερισμών (Ιχθύες ~37° εκλειπτικής)" },
        { model: "Ζώνη Κοσμικής Αυγής / Μετάβασης", entryYear: "1950 – 2150 μ.Χ.", notes: "Μεταβατικό λυκόφως επικάλυψης των αρχετύπων Ιχθύων & Υδροχόου" }
      ]
    },
    piscesStartBCE: 160,
...
export const ZODIAC_SIGNS_DATA: ZodiacSignData[] = [
  {
    ...
    greatAgeSpan: "2.320 π.Χ. – 160 π.Χ.",
    precessionOrder: 1,
  ...
  },
  {
    ...
    greatAgeYears: "2.160 Έτη",
    greatAgeSpan: "4.480 π.Χ. – 2.320 π.Χ.",
    precessionOrder: 2,
  ...
  },
  {
    ...
    greatAgeYears: "2.160 Έτη",
    greatAgeSpan: "6.640 π.Χ. – 4.480 π.Χ.",
    precessionOrder: 3,
  ...
  },
  {
    ...
    greatAgeYears: "2.160 Έτη",
    greatAgeSpan: "8.800 π.Χ. – 6.640 π.Χ.",
    precessionOrder: 4,
  ...
  },
  {
    ...
    greatAgeYears: "2.160 Έτη",
    greatAgeSpan: "10.960 π.Χ. – 8.800 π.Χ.",
    precessionOrder: 5,
    greatAgeArchetype: "Εποχή του Λέοντος / Χρυσή Ηλιακή Εποχή / Μεγάλη Σφίγγα & Κατακλυσμός",
    greatAgeHistory: "Η εποχή της κατασκευής των πρωταρχικών ηλιακών μνημείων (όπως η Μεγάλη Σφίγγα με σώμα λέοντος στραμμένη στην ανατολή του Λέοντος το ~10.500 π.Χ., Γκιομπεκλί Τεπέ). Ηλιακές λατρείες του Απόλλωνος και του αρχέγονου φωτός.",
  ...
  },
  {
    ...
    greatAgeYears: "2.160 Έτη",
    greatAgeSpan: "13.120 π.Χ. – 10.960 π.Χ.",
    precessionOrder: 6,
  ...
  },
  {
    ...
    greatAgeYears: "2.160 Έτη",
    greatAgeSpan: "15.280 π.Χ. – 13.120 π.Χ.",
    precessionOrder: 7,
  ...
  },
  {
    ...
    greatAgeYears: "2.160 Έτη",
    greatAgeSpan: "17.440 π.Χ. – 15.280 π.Χ.",
    precessionOrder: 8,
  ...
  },
  {
    ...
    greatAgeYears: "2.160 Έτη",
    greatAgeSpan: "19.600 π.Χ. – 17.440 π.Χ.",
    precessionOrder: 9,
  ...
  },
  {
    ...
    greatAgeYears: "2.160 Έτη",
    greatAgeSpan: "4.160 μ.Χ. – 6.320 μ.Χ. (ή 21.760 π.Χ. – 19.600 π.Χ.)",
    precessionOrder: 10,
  ...
  },
  {
    ...
    greatAgeYears: "2.160 Έτη",
    greatAgeSpan: "2.000 μ.Χ. – 4.160 μ.Χ.",
    precessionOrder: 11,
    greatAgeArchetype: "Εποχή του Υδροχόου / Προμηθεύς & Γανυμήδης / Έκχυση της Γνώσεως & Ενότης",
    greatAgeHistory: "Η ΤΡΕΧΟΥΣΑ ΝΕΑ ΕΠΟΧΗ του Μέγα Ενιαυτού, με εκκίνηση το Millennium (2000 μ.Χ.). Χαρακτηρίζεται από την κατάργηση των τυφλών δογμάτων, την έκχυση της γνώσης (Ύδωρ της Σοφίας) σε όλη την ανθρωπότητα, την τεχνολογική και πνευματική ένωση, την κατανόηση των συμπαντικών κυμάτων και του Αιθέρα.",
  ...
  },
  {
    ...
    greatAgeYears: "2.160 Έτη",
    greatAgeSpan: "160 π.Χ. – 2.000 μ.Χ.",
    precessionOrder: 12,
    greatAgeArchetype: "Εποχή των Ιχθύων / Πίστις, Αυταπάρνηση, Ωκεάνιος Συγχώνευση & ΙΧΘΥΣ",
    greatAgeHistory: "Η ιστορική εποχή από το 160 π.Χ. έως το 2000 μ.Χ. Ο Ιησούς Χριστός γεννήθηκε στο 1 μ.Χ., δηλαδή στο 160ό έτος Μετά Ιχθύος (2° 13' 20'' των Ιχθύων). Κυριαρχία του συμβόλου του Ιχθύος (ΙΧΘΥΣ = Ιησούς Χριστός Θεού Υιός Σωτήρ = 1219), διάδοση των παγκόσμιων θρησκειών πίστεως, ωκεάνιες εξερευνήσεις, άνοδος του μυστικισμού.",
...
export function calculateGreatYearEra(inputYear: number): GreatYearCalculationResult {
  ...
  let christRel = "";
  if (inputYear === 2026) {
    christRel = "Στο έτος 2026 μ.Χ. διανύουμε το 26ο έτος της Εποχής του Υδροχόου. Επειδή η μετάβαση στον Υδροχόο έγινε το 2000 μ.Χ., η Εποχή των Ιχθύων (2.160 έτη) διήρκεσε από το 160 π.Χ. έως το 2000 μ.Χ. Άρα ο Ιησούς Χριστός (1 μ.Χ.) γεννήθηκε στο 160ό έτος της Εποχής των Ιχθύων (160 Μετά Ιχθύος / 2° 13' 20'' Ιχθύων).";
    ...
    christRel = `Εποχή των Ιχθύων (${yearPisces}ο έτος Ιχθύων). Ο Ιησούς Χριστός (1 μ.Χ.) αντιστοιχεί στο 160ό έτος της Εποχής αυτής.`;
  } else {
  ...
  if (inputYear >= 2000 && inputYear <= 2050) {
    ...
    notes = `Πλήρης άνθηση της Εποχής του Υδροχόου. Απομένουν ${yearsRemainingInAge} έτη έως την Εποχή του Αιγοκέρωτος (4.160 μ.Χ.).`;
  } else if (inputYear >= -160 && inputYear < 2000) {
    notes = `Εποχή των Ιχθύων (160 π.Χ. – 2000 μ.Χ.). Σημείο εαρινής ισημερίας στον αστερισμό των Ιχθύων.`;
  } else {
