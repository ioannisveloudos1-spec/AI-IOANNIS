...
export const SACRED_REPDIGITS_SERIES: SacredRepdigitMatch[] = [
  ...
  },
  {
    ...
    meaning: "Ο ΙΗΣΟΥΣ (Ογδοάς, Λόγος του Φωτός, JE+S+US, Ίαση/Ιασώ «τῆς Ἰησοῦς», απόγονος & ίδιος Εαυτός Απόλλωνος/Διός/Κρόνου/Ουρανού/Χάους) και ο ΩΛΗΝ (ο αρχαιότερος δελφικός ποιητής & υμνογράφος).",
